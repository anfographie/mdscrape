---
title: "Introduction"
source: "https://nextjs.org/docs/13"
---
...
FeatureDescription[Routing](/docs/13/app/building-your-application/routing)A file-system based router built on top of Server Components that supports layouts, nested routing, loading states, error handling, and more.[Rendering](/docs/13/app/building-your-application/rendering)Client-side and Server-side Rendering with Client and Server Components. Further optimized with Static and Dynamic Rendering on the server with Next.js. Streaming on Edge and Node.js runtimes.[Data Fetching](/docs/13/app/building-your-application/data-fetching)Simplified data fetching with async/await in Server Components, and an extended `fetch` API for request memoization, data caching and revalidation.[Styling](/docs/13/app/building-your-application/styling)Support for your preferred styling methods, including CSS Modules, Tailwind CSS, and CSS-in-JS[Optimizations](/docs/13/app/building-your-application/optimizing)Image, Fonts, and Script Optimizations to improve your application's Core Web Vitals and User Experience.[TypeScript](/docs/13/app/building-your-application/configuring/typescript)Improved support for TypeScript, with better type checking and more efficient compilation, as well as custom TypeScript Plugin and type checker.
...
To get started, checkout the [Installation](/docs/13/getting-started/installation) guide.
...
[**Getting Started**  
\
Learn how to create full-stack web applications with Next.js.](/docs/13/getting-started)
...
[**Building Your Application**  
\
Learn how to use Next.js features to build your application.](/docs/13/pages/building-your-application)

[**API Reference**  
\
Next.js API Reference for the Pages Router.](/docs/13/pages/api-reference)

[**Architecture**  
\
How Next.js Works](/docs/13/architecture)

[**Community**  
\
Get involved in the Next.js community.](/docs/13/community)
