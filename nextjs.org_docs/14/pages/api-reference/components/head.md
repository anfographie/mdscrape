---
title: "<Head>"
source: "https://nextjs.org/docs/14/pages/api-reference/components/head"
---
...
[API Reference](/docs/14/pages/api-reference)[Components](/docs/14/pages/api-reference/components)&lt;Head&gt;
...
We recommend using [`next/script`](/docs/14/pages/building-your-application/optimizing/scripts) in your component instead of manually creating a `<script>` in `next/head`.
