---
title: "<Image>"
source: "https://nextjs.org/docs/14/pages/api-reference/components/image"
---
...
[API Reference](/docs/14/pages/api-reference)[Components](/docs/14/pages/api-reference/components)&lt;Image&gt;
...
> **Good to know**: If you are using a version of Next.js prior to 13, you'll want to use the [next/legacy/image](/docs/14/pages/api-reference/components/image-legacy) documentation since the component was renamed.
