---
title: "Font Module"
source: "https://nextjs.org/docs/14/pages/api-reference/components/font"
---
...
[API Reference](/docs/14/pages/api-reference)[Components](/docs/14/pages/api-reference/components)Font

You are currently viewing the Pages Router documentation for version 14 of Next.js.

# Font Module

This API reference will help you understand how to use [`next/font/google`](/docs/14/app/building-your-application/optimizing/fonts#google-fonts) and [`next/font/local`](/docs/14/app/building-your-application/optimizing/fonts#local-fonts). For features and usage, please see the [Optimizing Fonts](/docs/14/app/building-your-application/optimizing/fonts) page.

### [Font Function Arguments](#font-function-arguments)

For usage, review [Google Fonts](/docs/14/app/building-your-application/optimizing/fonts#google-fonts) and [Local Fonts](/docs/14/app/building-your-application/optimizing/fonts#local-fonts).
...
The font [`subsets`](https://fonts.google.com/knowledge/glossary/subsetting) defined by an array of string values with the names of each subset you would like to be [preloaded](/docs/14/app/building-your-application/optimizing/fonts#specifying-a-subset). Fonts specified via `subsets` will have a link preload tag injected into the head when the [`preload`](#preload) option is true, which is the default.
...
A boolean value that specifies whether the font should be [preloaded](/docs/14/app/building-your-application/optimizing/fonts#preloading) or not. The default is `true`.
