...
source: "https://nextjs.org/docs/14/pages/api-reference/next-config-js/webVitalsAttribution"
---
...
[API Reference](/docs/14/pages/api-reference)[next.config.js Options](/docs/14/pages/api-reference/next-config-js)webVitalsAttribution
