...
source: "https://nextjs.org/docs/14/pages/api-reference/functions/use-report-web-vitals"
---
...
[API Reference](/docs/14/pages/api-reference)[Functions](/docs/14/pages/api-reference/functions)useReportWebVitals
