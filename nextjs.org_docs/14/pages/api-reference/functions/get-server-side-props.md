...
[API Reference](/docs/14/pages/api-reference)[Functions](/docs/14/pages/api-reference/functions)getServerSideProps
...
VersionChanges`v13.4.0`[App Router](/docs/14/app/building-your-application/data-fetching) is now stable with simplified data fetching`v10.0.0``locale`, `locales`, `defaultLocale`, and `notFound` options added.`v9.3.0``getServerSideProps` introduced.
