---
title: "NextRequest"
source: "https://nextjs.org/docs/14/pages/api-reference/functions/next-request"
---
...
[API Reference](/docs/14/pages/api-reference)[Functions](/docs/14/pages/api-reference/functions)NextRequest
...
PropertyTypeDescription`basePath``string`The [base path](/docs/14/pages/api-reference/next-config-js/basePath) of the URL.`buildId``string` | `undefined`The build identifier of the Next.js application. Can be [customized](/docs/14/pages/api-reference/next-config-js/generateBuildId).`defaultLocale``string` | `undefined`The default locale for [internationalization](/docs/14/pages/building-your-application/routing/internationalization).`domainLocale`- `defaultLocale``string`The default locale within a domain.- `domain``string`The domain associated with a specific locale.- `http``boolean` | `undefined`Indicates if the domain is using HTTP.`locales``string[]` | `undefined`An array of available locales.`locale``string` | `undefined`The currently active locale.`url``URL`The URL object.
