---
title: "Edge Runtime"
source: "https://nextjs.org/docs/14/pages/api-reference/edge"
---
...
[Pages Router](/docs/14/pages)[API Reference](/docs/14/pages/api-reference)Edge Runtime
...
You can use `process.env` to access [Environment Variables](/docs/14/app/building-your-application/configuring/environment-variables) for both `next dev` and `next build`.
