---
title: "Middleware"
source: "https://nextjs.org/docs/14/pages/building-your-application/routing/middleware"
---
...
[Building Your Application](/docs/14/pages/building-your-application)[Routing](/docs/14/pages/building-your-application/routing)Middleware
...
1. `rewrite` to a route ([Page](/docs/14/pages/building-your-application/routing/pages-and-layouts) or [Edge API Route](/docs/14/pages/building-your-application/routing/api-routes)) that produces a response
