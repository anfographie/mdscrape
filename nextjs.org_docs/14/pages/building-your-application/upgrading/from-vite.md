...
source: "https://nextjs.org/docs/14/pages/building-your-application/upgrading/from-vite"
---
...
[Building Your Application](/docs/14/pages/building-your-application)[Upgrading](/docs/14/pages/building-your-application/upgrading)Migrating from Vite
...
6. Finally, Next.js can manage your last `<head>` tags with the [Metadata API](/docs/14/app/building-your-application/optimizing/metadata). Move your final metadata info into an exported [`metadata` object](/docs/14/app/api-reference/functions/generate-metadata#metadata-object):
...
Next.js has support for `.env` [environment variables](/docs/14/app/building-your-application/configuring/environment-variables) similar to Vite. The main difference is the prefix used to expose environment variables on the client-side.
...
2. **Set [`basePath`](/docs/14/app/api-reference/next-config-js/basePath) to `process.env.NEXT_PUBLIC_BASE_PATH` in your `next.config.mjs` file:**
