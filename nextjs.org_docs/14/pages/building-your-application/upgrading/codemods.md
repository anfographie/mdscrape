...
[Building Your Application](/docs/14/pages/building-your-application)[Upgrading](/docs/14/pages/building-your-application/upgrading)Codemods
...
Remove `<a>` tags inside [Link Components](/docs/14/pages/api-reference/components/link), or add a `legacyBehavior` prop to Links that cannot be auto-fixed.
