---
title: "Debugging"
source: "https://nextjs.org/docs/14/pages/building-your-application/configuring/debugging"
---
...
[Building Your Application](/docs/14/pages/building-your-application)[Configuring](/docs/14/pages/building-your-application/configuring)Debugging
...
If you're [changing the port number](/docs/14/pages/api-reference/cli/next#next-dev-options) your application starts on, replace the `3000` in `http://localhost:3000` with the port you're using instead.
