...
source: "https://nextjs.org/docs/14/pages/building-your-application/optimizing/third-party-libraries"
---
...
[Building Your Application](/docs/14/pages/building-your-application)[Optimizing](/docs/14/pages/building-your-application/optimizing)Third Party Libraries
...
NameTypeDescription`gaId`RequiredYour [measurement ID](https://support.google.com/analytics/answer/12270356). Usually starts with `G-`.`dataLayerName`OptionalName of the data layer. Defaults to `dataLayer`.
