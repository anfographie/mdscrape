...
source: "https://nextjs.org/docs/14/pages/building-your-application/optimizing/scripts"
---
...
[Building Your Application](/docs/14/pages/building-your-application)[Optimizing](/docs/14/pages/building-your-application/optimizing)Scripts
...
Refer to the [`next/script`](/docs/14/pages/api-reference/components/script#onload) API reference to learn more about each event handler and view examples.
