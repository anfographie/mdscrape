...
[Building Your Application](/docs/14/pages/building-your-application)[Deploying](/docs/14/pages/building-your-application/deploying)Continuous Integration (CI) Build Caching
...
> If your CI is not configured to persist `.next/cache` between builds, you may see a [No Cache Detected](/docs/14/messages/no-cache) error.
