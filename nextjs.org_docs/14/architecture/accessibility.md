---
title: "Accessibility"
source: "https://nextjs.org/docs/14/architecture/accessibility"
---
...
[Introduction](/docs/14)[Architecture](/docs/14/architecture)Accessibility
...
Next.js provides an [integrated ESLint experience](/docs/14/pages/building-your-application/configuring/eslint) out of the box, including custom rules for Next.js. By default, Next.js includes `eslint-plugin-jsx-a11y` to help catch accessibility issues early, including warning on:
