...
source: "https://nextjs.org/docs/14/architecture/nextjs-compiler"
---
...
[Introduction](/docs/14)[Architecture](/docs/14/architecture)Next.js Compiler
...
This option has been superseded by [`optimizePackageImports`](/docs/14/app/api-reference/next-config-js/optimizePackageImports) in Next.js 13.5. We recommend upgrading to use the new option that does not require manual configuration of import paths.
