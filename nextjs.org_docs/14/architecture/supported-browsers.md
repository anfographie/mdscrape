...
source: "https://nextjs.org/docs/14/architecture/supported-browsers"
---
...
[Introduction](/docs/14)[Architecture](/docs/14/architecture)Supported Browsers
...
In this case, you should add a top-level import for the **specific polyfill** you need in your [Custom `<App>`](/docs/14/pages/building-your-application/routing/custom-app) or the individual component.
...
Next.js has built-in TypeScript support. [Learn more here](/docs/14/pages/building-your-application/configuring/typescript).

### [Customizing Babel Config (Advanced)](#customizing-babel-config-advanced)

You can customize babel configuration. [Learn more here](/docs/14/pages/building-your-application/configuring/babel).
