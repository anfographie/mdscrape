...
[Building Your Application](/docs/14/app/building-your-application)[Optimizing](/docs/14/app/building-your-application/optimizing)Images
...
Since Next.js does not have access to remote files during the build process, you'll need to provide the [`width`](/docs/14/app/api-reference/components/image#width), [`height`](/docs/14/app/api-reference/components/image#height) and optional [`blurDataURL`](/docs/14/app/api-reference/components/image#blurdataurl) props manually.
...
Learn more about [`remotePatterns`](/docs/14/app/api-reference/components/image#remotepatterns) configuration. If you want to use relative URLs for the image `src`, use a [`loader`](/docs/14/app/api-reference/components/image#loader).
...
> Learn more about [`remotePatterns`](/docs/14/app/api-reference/components/image#remotepatterns) configuration.
...
You can define a loader per-image with the [`loader` prop](/docs/14/app/api-reference/components/image#loader), or at the application level with the [`loaderFile` configuration](/docs/14/app/api-reference/components/image#loaderfile).
...
See more about priority in the [`next/image` component documentation](/docs/14/app/api-reference/components/image#priority).
...
2. Explicitly, by including a [`width`](/docs/14/app/api-reference/components/image#width) and [`height`](/docs/14/app/api-reference/components/image#height) property
3. Implicitly, by using [fill](/docs/14/app/api-reference/components/image#fill) which causes the image to expand to fill its parent element.
...
- Use `className` or `style`, not `styled-jsx`.
  ...
  - In most cases, we recommend using the `className` prop. This can be an imported [CSS Module](/docs/14/app/building-your-application/styling/css-modules), a [global stylesheet](/docs/14/app/building-your-application/styling/css-modules#global-styles), etc.
  - You can also use the `style` prop to assign inline styles.
  - You cannot use [styled-jsx](/docs/14/app/building-your-application/styling/css-in-js) because it's scoped to the current component (unless you mark the style as `global`).
...
[**View all properties available to the `next/image` component.**](/docs/14/app/api-reference/components/image)

## [Configuration](#configuration)

The `next/image` component and Next.js Image Optimization API can be configured in the [`next.config.js` file](/docs/14/app/api-reference/next-config-js). These configurations allow you to [enable remote images](/docs/14/app/api-reference/components/image#remotepatterns), [define custom image breakpoints](/docs/14/app/api-reference/components/image#devicesizes), [change caching behavior](/docs/14/app/api-reference/components/image#caching-behavior) and more.

[**Read the full image configuration documentation for more information.**](/docs/14/app/api-reference/components/image#configuration-options)
...
**&lt;Image&gt;**  
\
Optimize Images in your Next.js Application using the built-in \`next/image\` Component.](/docs/14/app/api-reference/components/image)
