---
title: "Codemods"
source: "https://nextjs.org/docs/14/app/building-your-application/upgrading/codemods"
---
...
[Building Your Application](/docs/14/app/building-your-application)[Upgrading](/docs/14/app/building-your-application/upgrading)Codemods
...
This codemod moves transforms imports from `next/server` to `next/og` for usage of [Dynamic OG Image Generation](/docs/14/app/building-your-application/optimizing/metadata#dynamic-image-generation).
...
Remove `<a>` tags inside [Link Components](/docs/14/app/api-reference/components/link), or add a `legacyBehavior` prop to Links that cannot be auto-fixed.
...
Transforms the deprecated automatically injected `url` property on top level pages to using `withRouter` and the `router` property it injects. Read more here: [https://nextjs.org/docs/messages/url-deprecated](/docs/14/messages/url-deprecated)
