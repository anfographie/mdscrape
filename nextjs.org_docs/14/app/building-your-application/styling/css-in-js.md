...
[Building Your Application](/docs/14/app/building-your-application)[Styling](/docs/14/app/building-your-application/styling)CSS-in-JS
...
If you want to style Server Components, we recommend using [CSS Modules](/docs/14/app/building-your-application/styling/css-modules) or other solutions that output CSS files, like PostCSS or [Tailwind CSS](/docs/14/app/building-your-application/styling/tailwind-css).
...
Then, wrap your [root layout](/docs/14/app/building-your-application/routing/pages-and-layouts#root-layout-required) with the registry:
...
> - For advanced use cases where you need to configure individual properties of styled-components compilation, you can read our [Next.js styled-components API reference](/docs/14/architecture/nextjs-compiler#styled-components) to learn more.
