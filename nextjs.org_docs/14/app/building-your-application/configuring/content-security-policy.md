...
[Building Your Application](/docs/14/app/building-your-application)[Configuring](/docs/14/app/building-your-application/configuring)Content Security Policy
...
[Middleware](/docs/14/app/building-your-application/routing/middleware) enables you to add headers and generate nonces before the page renders.
...
By default, Middleware runs on all requests. You can filter Middleware to run on specific paths using a [`matcher`](/docs/14/app/building-your-application/routing/middleware#matcher).
...
You can now read the nonce from a [Server Component](/docs/14/app/building-your-application/rendering/server-components) using [`headers`](/docs/14/app/api-reference/functions/headers):
...
For applications that do not require nonces, you can set the CSP header directly in your [`next.config.js`](/docs/14/app/api-reference/next-config-js) file:
...
**headers**  
\
API reference for the headers function.](/docs/14/app/api-reference/functions/headers)
