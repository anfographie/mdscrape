...
[Building Your Application](/docs/14/app/building-your-application)[Configuring](/docs/14/app/building-your-application/configuring)MDX
...
To share a layout across MDX pages, you can use the [built-in layouts support](/docs/14/app/building-your-application/routing/pages-and-layouts#layouts) with the App Router.
