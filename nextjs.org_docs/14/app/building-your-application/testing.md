...
[App Router](/docs/14/app)[Building Your Application](/docs/14/app/building-your-application)Testing
...
[**Vitest**  
\
Learn how to set up Vitest with Next.js for Unit Testing.](/docs/14/app/building-your-application/testing/vitest)

[**Jest**  
\
Learn how to set up Jest with Next.js for Unit Testing and Snapshot Testing.](/docs/14/app/building-your-application/testing/jest)

[**Playwright**  
\
Learn how to set up Playwright with Next.js for End-to-End (E2E) testing.](/docs/14/app/building-your-application/testing/playwright)

[**Cypress**  
\
Learn how to set up Cypress with Next.js for End-to-End (E2E) and Component Testing.](/docs/14/app/building-your-application/testing/cypress)
