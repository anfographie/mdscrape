...
[Building Your Application](/docs/14/app/building-your-application)[Routing](/docs/14/app/building-your-application/routing)Error Handling

You are currently viewing documentation for version 14 of Next.js.

# Error Handling

The `error.js` file convention allows you to gracefully handle unexpected runtime errors in [nested routes](/docs/14/app/building-your-application/routing#nested-routes).
...
React components created through [special files](/docs/14/app/building-your-application/routing#file-conventions) are rendered in a [specific nested hierarchy](/docs/14/app/building-your-application/routing#component-hierarchy).
...
**error.js**  
\
API reference for the error.js special file.](/docs/14/app/api-reference/file-conventions/error)
