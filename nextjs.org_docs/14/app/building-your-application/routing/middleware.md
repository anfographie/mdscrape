...
[Building Your Application](/docs/14/app/building-your-application)[Routing](/docs/14/app/building-your-application/routing)Middleware
...
1. `rewrite` to a route ([Page](/docs/14/app/building-your-application/routing/pages-and-layouts) or [Route Handler](/docs/14/app/building-your-application/routing/route-handlers)) that produces a response
...
> **Good to know:** You can configure CORS headers for individual routes in [Route Handlers](/docs/14/app/building-your-application/routing/route-handlers#cors).
...
Middleware currently only supports the [Edge runtime](/docs/14/app/building-your-application/rendering/edge-and-nodejs-runtimes). The Node.js runtime can not be used.
