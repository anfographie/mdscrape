...
source: "https://nextjs.org/docs/14/app/api-reference/functions/use-report-web-vitals"
---
...
[API Reference](/docs/14/app/api-reference)[Functions](/docs/14/app/api-reference/functions)useReportWebVitals
