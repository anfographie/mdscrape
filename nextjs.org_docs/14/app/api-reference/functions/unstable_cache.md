...
source: "https://nextjs.org/docs/14/app/api-reference/functions/unstable_cache"
---
...
[API Reference](/docs/14/app/api-reference)[Functions](/docs/14/app/api-reference/functions)unstable\_cache
...
VersionChanges`v14.0.0``unstable_cache` introduced.
