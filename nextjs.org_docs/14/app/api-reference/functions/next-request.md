---
title: "NextRequest"
source: "https://nextjs.org/docs/14/app/api-reference/functions/next-request"
---
...
[API Reference](/docs/14/app/api-reference)[Functions](/docs/14/app/api-reference/functions)NextRequest
...
PropertyTypeDescription`basePath``string`The [base path](/docs/14/app/api-reference/next-config-js/basePath) of the URL.`buildId``string` | `undefined`The build identifier of the Next.js application. Can be [customized](/docs/14/app/api-reference/next-config-js/generateBuildId).`pathname``string`The pathname of the URL.`searchParams``Object`The search parameters of the URL.

> **Note:** The internationalization properties from the Pages Router are not available for usage in the App Router. Learn more about [internationalization with the App Router](/docs/14/app/building-your-application/routing/internationalization).
