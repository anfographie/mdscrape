---
title: "headers"
source: "https://nextjs.org/docs/14/app/api-reference/functions/headers"
---
...
[API Reference](/docs/14/app/api-reference)[Functions](/docs/14/app/api-reference/functions)headers

You are currently viewing documentation for version 14 of Next.js.

# headers

The `headers` function allows you to read the HTTP incoming request headers from a [Server Component](/docs/14/app/building-your-application/rendering/server-components).
...
`headers()` can be used in combination with [Suspense for Data Fetching](/docs/14/app/building-your-application/data-fetching/fetching-caching-and-revalidating).
...
VersionChanges`v13.0.0``headers` introduced.
