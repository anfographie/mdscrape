...
source: "https://nextjs.org/docs/14/app/api-reference/functions/generate-image-metadata"
---
...
[API Reference](/docs/14/app/api-reference)[Functions](/docs/14/app/api-reference/functions)generateImageMetadata
...
An object containing the [dynamic route parameters](/docs/14/app/building-your-application/routing/dynamic-routes) object from the root segment down to the segment `generateImageMetadata` is called from.
...
This example uses the `params` object and external data to generate multiple [Open Graph images](/docs/14/app/api-reference/file-conventions/metadata/opengraph-image) for a route segment.
