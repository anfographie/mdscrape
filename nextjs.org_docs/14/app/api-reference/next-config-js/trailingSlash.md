---
title: "trailingSlash"
source: "https://nextjs.org/docs/14/app/api-reference/next-config-js/trailingSlash"
---
...
[API Reference](/docs/14/app/api-reference)[next.config.js Options](/docs/14/app/api-reference/next-config-js)trailingSlash
