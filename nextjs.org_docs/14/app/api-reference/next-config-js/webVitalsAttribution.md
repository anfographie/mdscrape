...
source: "https://nextjs.org/docs/14/app/api-reference/next-config-js/webVitalsAttribution"
---
...
[API Reference](/docs/14/app/api-reference)[next.config.js Options](/docs/14/app/api-reference/next-config-js)webVitalsAttribution
