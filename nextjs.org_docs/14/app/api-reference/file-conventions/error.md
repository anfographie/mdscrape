---
title: "error.js"
source: "https://nextjs.org/docs/14/app/api-reference/file-conventions/error"
---
...
[API Reference](/docs/14/app/api-reference)[File Conventions](/docs/14/app/api-reference/file-conventions)error.js
...
> **Good to know**:
> 
> - `error.js` boundaries must be [**Client Components**](/docs/14/app/building-your-application/rendering/client-components).
...
VersionChanges`v13.1.0``global-error` introduced.`v13.0.0``error` introduced.
