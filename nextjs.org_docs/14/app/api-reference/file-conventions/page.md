...
[API Reference](/docs/14/app/api-reference)[File Conventions](/docs/14/app/api-reference/file-conventions)page.js
...
An object containing the [dynamic route parameters](/docs/14/app/building-your-application/routing/dynamic-routes) from the root segment down to that page. For example:
...
> **Good to know**:
> 
> - `searchParams` is a [**Dynamic API**](/docs/14/app/building-your-application/rendering/server-components#server-rendering-strategies%23dynamic-functions) whose values cannot be known ahead of time. Using it will opt the page into [**dynamic rendering**](/docs/14/app/building-your-application/rendering/server-components#dynamic-rendering) at request time.
