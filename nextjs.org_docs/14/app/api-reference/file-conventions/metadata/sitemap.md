---
title: "sitemap.xml"
source: "https://nextjs.org/docs/14/app/api-reference/file-conventions/metadata/sitemap"
---
...
[File Conventions](/docs/14/app/api-reference/file-conventions)[Metadata Files](/docs/14/app/api-reference/file-conventions/metadata)sitemap.xml
...
- By using the [`generateSitemaps`](/docs/14/app/api-reference/functions/generate-sitemaps) function.
...
See the [`generateSitemaps` API reference](/docs/14/app/api-reference/functions/generate-sitemaps) for more information.
...
VersionChanges`v13.4.5`Add `changeFrequency` and `priority` attributes to sitemaps.`v13.3.0``sitemap` introduced.
...
**generateSitemaps**  
\
Learn how to use the generateSiteMaps function to create multiple sitemaps for your application.](/docs/14/app/api-reference/functions/generate-sitemaps)
