---
title: "route.js"
source: "https://nextjs.org/docs/14/app/api-reference/file-conventions/route"
---
...
[API Reference](/docs/14/app/api-reference)[File Conventions](/docs/14/app/api-reference/file-conventions)route.js
...
Currently, the only value of `context` is `params`, which is an object containing the [dynamic route parameters](/docs/14/app/building-your-application/routing/dynamic-routes) for the current route.
...
Route Handlers can extend the Web Response API by returning a `NextResponse` object. This allows you to easily set cookies, headers, redirect, and rewrite. [View the API reference](/docs/14/app/api-reference/functions/next-response).
