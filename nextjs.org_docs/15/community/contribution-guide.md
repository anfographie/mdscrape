...
source: "https://nextjs.org/docs/15/community/contribution-guide"
---
...
[Next.js Docs](/docs/15)[Community](/docs/15/community)Contribution Guide
...
For example, in the [functions API Reference](/docs/15/app/api-reference/functions), the pages are sorted alphabetically because it makes it easier for developers to find a specific function:
...
But, in the [routing section](/docs/15/app), the files are prefixed with a two-digit number, sorted in the order developers should learn these concepts:
...
The diagrams currently live in the `/public` folder in our private Next.js site. If you'd like to update or add a diagram, please open a [GitHub issue](https://github.com/vercel/next.js/issues/new?assignees=&labels=template%3A%20documentation&projects=&template=4.docs_request.yml&title=Docs%3A%20) with your ideas.
