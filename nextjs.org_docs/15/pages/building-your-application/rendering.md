---
title: "Rendering"
source: "https://nextjs.org/docs/15/pages/building-your-application/rendering"
---
...
[Pages Router](/docs/15/pages)[Building Your Application](/docs/15/pages/building-your-application)Rendering
...
\
Next.js automatically optimizes your app to be static HTML whenever possible. Learn how it works here.](/docs/15/pages/building-your-application/rendering/automatic-static-optimization)

[**Client-side Rendering (CSR)**  
\
Learn how to implement client-side rendering in the Pages Router.](/docs/15/pages/building-your-application/rendering/client-side-rendering)
