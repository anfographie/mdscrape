---
title: "API Routes"
source: "https://nextjs.org/docs/15/pages/building-your-application/routing/api-routes"
---
...
[Building Your Application](/docs/15/pages/building-your-application)[Routing](/docs/15/pages/building-your-application/routing)API Routes
...
> **Good to know**: If you are using the App Router, you can use [Server Components](/docs/15/app/getting-started/server-and-client-components) or [Route Handlers](/docs/15/app/api-reference/file-conventions/route) instead of API Routes.
...
- API Routes can't be used with [static exports](/docs/15/pages/guides/static-exports). However, [Route Handlers](/docs/15/app/api-reference/file-conventions/route) in the App Router can.
  
  > - API Routes will be affected by [`pageExtensions` configuration](/docs/15/pages/api-reference/config/next-config-js/pageExtensions) in `next.config.js`.
...
- `res.revalidate(urlPath)` - [Revalidate a page on demand](/docs/15/pages/guides/incremental-static-regeneration#on-demand-revalidation-with-revalidatepath) using `getStaticProps`. `urlPath` must be a `string`.
...
API Routes support [dynamic routes](/docs/15/pages/building-your-application/routing/dynamic-routes), and follow the same file naming rules used for `pages/`.
...
While the Pages Router does support streaming responses with API Routes, we recommend incrementally adopting the App Router and using [Route Handlers](/docs/15/app/api-reference/file-conventions/route) if you are on Next.js 14+.
