...
source: "https://nextjs.org/docs/15/pages/api-reference/file-conventions/instrumentation"
---
...
[API Reference](/docs/15/pages/api-reference)[File-system conventions](/docs/15/pages/api-reference/file-conventions)instrumentation.js
...
To use it, place the file in the **root** of your application or inside a [`src` folder](/docs/15/app/api-reference/file-conventions/src-folder) if using one.
...
VersionChanges`v15.0.0``onRequestError` introduced, `instrumentation` stable`v14.0.4`Turbopack support for `instrumentation``v13.2.0``instrumentation` introduced as an experimental feature
