---
title: "src Directory"
source: "https://nextjs.org/docs/15/pages/api-reference/file-conventions/src-folder"
---
...
[API Reference](/docs/15/pages/api-reference)[File-system conventions](/docs/15/pages/api-reference/file-conventions)src Directory
