---
title: "useAmp"
source: "https://nextjs.org/docs/15/pages/api-reference/functions/use-amp"
---
...
[API Reference](/docs/15/pages/api-reference)[Functions](/docs/15/pages/api-reference/functions)useAmp
