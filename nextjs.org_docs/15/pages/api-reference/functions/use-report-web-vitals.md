...
source: "https://nextjs.org/docs/15/pages/api-reference/functions/use-report-web-vitals"
---
...
[API Reference](/docs/15/pages/api-reference)[Functions](/docs/15/pages/api-reference/functions)useReportWebVitals
