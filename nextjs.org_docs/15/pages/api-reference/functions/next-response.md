---
title: "NextResponse"
source: "https://nextjs.org/docs/15/pages/api-reference/functions/next-response"
---
...
[API Reference](/docs/15/pages/api-reference)[Functions](/docs/15/pages/api-reference/functions)NextResponse
