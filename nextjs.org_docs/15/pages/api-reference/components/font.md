---
title: "Font Module"
source: "https://nextjs.org/docs/15/pages/api-reference/components/font"
---
...
[API Reference](/docs/15/pages/api-reference)[Components](/docs/15/pages/api-reference/components)Font

You are currently viewing the Pages Router documentation for version 15 of Next.js.

# Font Module

[`next/font`](/docs/15/app/api-reference/components/font) automatically optimizes your fonts (including custom fonts) and removes external network requests for improved privacy and performance.
...
To use the font in all your pages, add it to [`_app.js` file](/docs/15/pages/building-your-application/routing/custom-app) under `/pages` as shown below:
...
Key`font/google``font/local`TypeRequired[`src`](#src)String or Array of ObjectsYes[`weight`](#weight)String or ArrayRequired/Optional[`style`](#style)String or Array-[`subsets`](#subsets)Array of Strings-[`axes`](#axes)Array of Strings-[`display`](#display)String-[`preload`](#preload)Boolean-[`fallback`](#fallback)Array of Strings-[`adjustFontFallback`](#adjustfontfallback)Boolean or String-[`variable`](#variable)String-[`declarations`](#declarations)Array of Objects-
...
The font [`subsets`](https://fonts.google.com/knowledge/glossary/subsetting) defined by an array of string values with the names of each subset you would like to be [preloaded](/docs/15/app/api-reference/components/font#specifying-a-subset). Fonts specified via `subsets` will have a link preload tag injected into the head when the [`preload`](#preload) option is true, which is the default.
...
A boolean value that specifies whether the font should be [preloaded](/docs/15/app/api-reference/components/font#preloading) or not. The default is `true`.
...
View the [Font API Reference](/docs/15/app/api-reference/components/font) for more information.
...
Alternatively, you can create a [CSS variable](/docs/15/app/api-reference/components/font#variable) and use it with your preferred CSS solution:
...
`next/font` integrates seamlessly with [Tailwind CSS](https://tailwindcss.com/) using [CSS variables](/docs/15/app/api-reference/components/font#css-variables).
...
Finally, add the CSS variable to your [Tailwind CSS config](/docs/15/app/getting-started/css#tailwind-css):
...
- if it's a [unique page](/docs/15/pages/building-your-application/routing/pages-and-layouts), it is preloaded on the unique route for that page
- if it's in the [custom App](/docs/15/pages/building-your-application/routing/custom-app), it is preloaded on all the routes of the site under `/pages`

## [Version Changes](#version-changes)

VersionChanges`v13.2.0``@next/font` renamed to `next/font`. Installation no longer required.`v13.0.0``@next/font` was added.
