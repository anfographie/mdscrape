---
title: "Script"
source: "https://nextjs.org/docs/15/pages/api-reference/components/script"
---
...
[API Reference](/docs/15/pages/api-reference)[Components](/docs/15/pages/api-reference/components)Script

You are currently viewing the Pages Router documentation for version 15 of Next.js.

# Script

This API reference will help you understand how to use [props](#props) available for the Script Component. For features and usage, please see the [Optimizing Scripts](/docs/15/app/guides/scripts) page.
