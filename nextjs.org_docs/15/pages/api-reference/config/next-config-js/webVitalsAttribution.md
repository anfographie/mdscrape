...
source: "https://nextjs.org/docs/15/pages/api-reference/config/next-config-js/webVitalsAttribution"
---
...
[Configuration](/docs/15/pages/api-reference/config)[next.config.js Options](/docs/15/pages/api-reference/config/next-config-js)webVitalsAttribution
