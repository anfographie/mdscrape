...
source: "https://nextjs.org/docs/15/pages/api-reference/config/next-config-js/pageExtensions"
---
...
[Configuration](/docs/15/pages/api-reference/config)[next.config.js Options](/docs/15/pages/api-reference/config/next-config-js)pageExtensions
...
- [`middleware.js`](/docs/15/pages/api-reference/file-conventions/middleware)
- [`instrumentation.js`](/docs/15/pages/guides/instrumentation)
- `pages/_document.js`
- `pages/_app.js`
- `pages/api/`
