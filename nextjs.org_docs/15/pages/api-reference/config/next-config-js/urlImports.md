---
title: "urlImports"
source: "https://nextjs.org/docs/15/pages/api-reference/config/next-config-js/urlImports"
---
...
[Configuration](/docs/15/pages/api-reference/config)[next.config.js Options](/docs/15/pages/api-reference/config/next-config-js)urlImports
