...
source: "https://nextjs.org/docs/15/pages/api-reference/config/next-config-js/webpack"
---
...
[Configuration](/docs/15/pages/api-reference/config)[next.config.js Options](/docs/15/pages/api-reference/config/next-config-js)webpack
...
- [CSS imports](/docs/15/app/getting-started/css)
- [CSS modules](/docs/15/app/getting-started/css)
- [Sass/SCSS imports](/docs/15/pages/guides/sass)
- [Sass/SCSS modules](/docs/15/pages/guides/sass)
- [Customizing babel configuration](/docs/15/pages/guides/babel)
