...
source: "https://nextjs.org/docs/15/pages/guides/upgrading/version-9"
---
...
[Guides](/docs/15/pages/guides)[Upgrading](/docs/15/pages/guides/upgrading)Version 9
...
If you previously copied the [Custom `<App>`](/docs/15/pages/building-your-application/routing/custom-app) example, you may be able to remove your `getInitialProps`.
