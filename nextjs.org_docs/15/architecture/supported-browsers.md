...
source: "https://nextjs.org/docs/15/architecture/supported-browsers"
---
...
[Next.js Docs](/docs/15)[Architecture](/docs/15/architecture)Supported Browsers
...
To include polyfills, you can import them into the [`instrumentation-client.js` file](/docs/15/app/api-reference/file-conventions/instrumentation-client).
...
In this case, you should add a top-level import for the **specific polyfill** you need in your [Custom `<App>`](/docs/15/pages/building-your-application/routing/custom-app) or the individual component.
...
Next.js has built-in TypeScript support. [Learn more here](/docs/15/pages/api-reference/config/typescript).

### [Customizing Babel Config (Advanced)](#customizing-babel-config-advanced)

You can customize babel configuration. [Learn more here](/docs/15/pages/guides/babel).
