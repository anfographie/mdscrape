---
title: "Accessibility"
source: "https://nextjs.org/docs/15/architecture/accessibility"
---
...
[Next.js Docs](/docs/15)[Architecture](/docs/15/architecture)Accessibility
...
Next.js provides an [integrated ESLint experience](/docs/15/pages/api-reference/config/eslint) out of the box, including custom rules for Next.js. By default, Next.js includes `eslint-plugin-jsx-a11y` to help catch accessibility issues early, including warning on:
