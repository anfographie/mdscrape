---
title: "Edge Runtime"
source: "https://nextjs.org/docs/13/pages/api-reference/edge"
---
...
[Pages Router](/docs/13/pages)[API Reference](/docs/13/pages/api-reference)Edge Runtime
...
You can use `process.env` to access [Environment Variables](/docs/13/app/building-your-application/configuring/environment-variables) for both `next dev` and `next build`.
