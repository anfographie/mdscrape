...
source: "https://nextjs.org/docs/13/pages/api-reference/functions/get-server-side-props"
---
...
[API Reference](/docs/13/pages/api-reference)[Functions](/docs/13/pages/api-reference/functions)getServerSideProps
...
VersionChanges`v13.4.0`[App Router](/docs/13/app/building-your-application/data-fetching) is now stable with simplifed data fetching`v10.0.0``locale`, `locales`, `defaultLocale`, and `notFound` options added.`v9.3.0``getServerSideProps` introduced.
