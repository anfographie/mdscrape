---
title: "useAmp"
source: "https://nextjs.org/docs/13/pages/api-reference/functions/use-amp"
---
...
[API Reference](/docs/13/pages/api-reference)[Functions](/docs/13/pages/api-reference/functions)useAmp
...
> AMP support is one of our advanced features, you can [read more about AMP here](/docs/13/pages/building-your-application/configuring/amp).
