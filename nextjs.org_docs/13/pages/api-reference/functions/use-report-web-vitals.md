...
source: "https://nextjs.org/docs/13/pages/api-reference/functions/use-report-web-vitals"
---
...
[API Reference](/docs/13/pages/api-reference)[Functions](/docs/13/pages/api-reference/functions)useReportWebVitals
