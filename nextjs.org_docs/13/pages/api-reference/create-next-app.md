...
source: "https://nextjs.org/docs/13/pages/api-reference/create-next-app"
---
...
[Pages Router](/docs/13/pages)[API Reference](/docs/13/pages/api-reference)create-next-app
