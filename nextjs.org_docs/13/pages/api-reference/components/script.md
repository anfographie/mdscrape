---
title: "<Script>"
source: "https://nextjs.org/docs/13/pages/api-reference/components/script"
---
...
[API Reference](/docs/13/pages/api-reference)[Components](/docs/13/pages/api-reference/components)&lt;Script&gt;

You are currently viewing the Pages Router documentation for version 13 of Next.js.

# &lt;Script&gt;

This API reference will help you understand how to use [props](#props) available for the Script Component. For features and usage, please see the [Optimizing Scripts](/docs/13/app/building-your-application/optimizing/scripts) page.
...
> **Warning:** The `worker` strategy is not yet stable and does not yet work with the [`app`](/docs/13/app/building-your-application/routing/defining-routes) directory. Use with caution.
