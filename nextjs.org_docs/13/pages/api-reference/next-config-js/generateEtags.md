---
title: "generateEtags"
source: "https://nextjs.org/docs/13/pages/api-reference/next-config-js/generateEtags"
---
...
[API Reference](/docs/13/pages/api-reference)[next.config.js Options](/docs/13/pages/api-reference/next-config-js)generateEtags
