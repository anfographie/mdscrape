---
title: "headers"
source: "https://nextjs.org/docs/13/pages/api-reference/next-config-js/headers"
---
...
[API Reference](/docs/13/pages/api-reference)[next.config.js Options](/docs/13/pages/api-reference/next-config-js)headers
...
When leveraging [`basePath` support](/docs/13/app/api-reference/next-config-js/basePath) with headers each `source` is automatically prefixed with the `basePath` unless you add `basePath: false` to the header:
...
If you need to revalidate the cache of a page that has been [statically generated](/docs/13/pages/building-your-application/rendering/static-site-generation), you can do so by setting the `revalidate` prop in the page's [`getStaticProps`](/docs/13/pages/building-your-application/data-fetching/get-static-props) function.

You can set the `Cache-Control` header in your [API Routes](/docs/13/pages/building-your-application/routing/api-routes) by using the `res.setHeader` method:
...
Learn more about adding a [Content Security Policy](/docs/13/app/building-your-application/configuring/content-security-policy) to your application.
