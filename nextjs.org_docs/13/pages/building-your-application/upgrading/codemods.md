---
title: "Codemods"
source: "https://nextjs.org/docs/13/pages/building-your-application/upgrading/codemods"
---
...
[Building Your Application](/docs/13/pages/building-your-application)[Upgrading](/docs/13/pages/building-your-application/upgrading)Codemods
...
Remove `<a>` tags inside [Link Components](/docs/13/pages/api-reference/components/link), or add a `legacyBehavior` prop to Links that cannot be auto-fixed.
...
Transforms the deprecated automatically injected `url` property on top level pages to using `withRouter` and the `router` property it injects. Read more here: [https://nextjs.org/docs/messages/url-deprecated](/docs/13/messages/url-deprecated)
