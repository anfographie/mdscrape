...
[Building Your Application](/docs/13/pages/building-your-application)[Upgrading](/docs/13/pages/building-your-application/upgrading)Version 11
...
Webpack 5 is now the default for all Next.js applications. If you did not have a custom webpack configuration, your application is already using webpack 5. If you do have a custom webpack configuration, you can refer to the [Next.js webpack 5 documentation](/docs/13/messages/webpack5) for upgrade guidance.
...
If your `pages/_app.js` imports `Container` from `next/app` you can remove `Container` as it was removed. Learn more in [the documentation](/docs/13/messages/app-container-deprecated).
...
You can learn more in [the documentation](/docs/13/messages/url-deprecated).
...
If your application does use `modules` and `render` you can refer to [the documentation](/docs/13/messages/next-dynamic-modules).
...
React 17 introduced a new [JSX Transform](https://reactjs.org/blog/2020/09/22/introducing-the-new-jsx-transform.html) that brings a long-time Next.js feature to the wider React ecosystem: Not having to `import React from 'react'` when using JSX. When using React 17 Next.js will automatically use the new transform. This transform does not make the `React` variable global, which was an unintended side-effect of the previous Next.js implementation. A [codemod is available](/docs/13/pages/building-your-application/upgrading/codemods#add-missing-react-import) to automatically fix cases where you accidentally used `React` without importing it.
