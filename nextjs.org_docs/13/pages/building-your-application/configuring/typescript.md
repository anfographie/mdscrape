---
title: "TypeScript"
source: "https://nextjs.org/docs/13/pages/building-your-application/configuring/typescript"
---
...
[Building Your Application](/docs/13/pages/building-your-application)[Configuring](/docs/13/pages/building-your-application/configuring)TypeScript
...
For [`getStaticProps`](/docs/13/pages/api-reference/functions/get-static-props), [`getStaticPaths`](/docs/13/pages/api-reference/functions/get-static-paths), and [`getServerSideProps`](/docs/13/pages/api-reference/functions/get-server-side-props), you can use the `GetStaticProps`, `GetStaticPaths`, and `GetServerSideProps` types respectively:
...
If you have a [custom `App`](/docs/13/pages/building-your-application/routing/custom-app), you can use the built-in type `AppProps` and change file name to `./pages/_app.tsx` like so:
...
You can learn more about this feature on the [Module Path aliases documentation](/docs/13/pages/building-your-application/configuring/absolute-imports-and-module-aliases).
