...
source: "https://nextjs.org/docs/13/pages/building-your-application/configuring/environment-variables"
---
...
[Building Your Application](/docs/13/pages/building-your-application)[Configuring](/docs/13/pages/building-your-application/configuring)Environment Variables
...
This loads `process.env.DB_HOST`, `process.env.DB_USER`, and `process.env.DB_PASS` into the Node.js environment automatically allowing you to use them in [Next.js data fetching methods](/docs/13/pages/building-your-application/data-fetching) and [API routes](/docs/13/pages/building-your-application/routing/api-routes).

For example, using [`getStaticProps`](/docs/13/pages/building-your-application/data-fetching/get-static-props):
...
- If you are using a [`/src` directory](/docs/13/app/building-your-application/configuring/src-directory), `.env.*` files should remain in the root of your project.
