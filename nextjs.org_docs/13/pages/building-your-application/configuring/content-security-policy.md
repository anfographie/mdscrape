...
source: "https://nextjs.org/docs/13/pages/building-your-application/configuring/content-security-policy"
---
...
[Building Your Application](/docs/13/pages/building-your-application)[Configuring](/docs/13/pages/building-your-application/configuring)Content Security Policy
...
[Middleware](/docs/13/app/building-your-application/routing/middleware) enables you to add headers and generate nonces before the page renders.
...
By default, Middleware runs on all requests. You can filter Middleware to run on specific paths using a [`matcher`](/docs/13/app/building-your-application/routing/middleware#matcher).
...
You can now read the nonce from a [Server Component](/docs/13/app/building-your-application/rendering/server-components) using [`headers`](/docs/13/app/api-reference/functions/headers):
