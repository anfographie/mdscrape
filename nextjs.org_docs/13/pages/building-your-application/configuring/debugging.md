---
title: "Debugging"
source: "https://nextjs.org/docs/13/pages/building-your-application/configuring/debugging"
---
...
[Building Your Application](/docs/13/pages/building-your-application)[Configuring](/docs/13/pages/building-your-application/configuring)Debugging
...
`npm run dev` can be replaced with `yarn dev` if you're using Yarn. If you're [changing the port number](/docs/13/pages/api-reference/next-cli#development) your application starts on, replace the `3000` in `http://localhost:3000` with the port you're using instead.
