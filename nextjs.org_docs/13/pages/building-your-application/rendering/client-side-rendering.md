...
source: "https://nextjs.org/docs/13/pages/building-your-application/rendering/client-side-rendering"
---
...
[Building Your Application](/docs/13/pages/building-your-application)[Rendering](/docs/13/pages/building-your-application/rendering)Client-side Rendering (CSR)
...
1. Using React's `useEffect()` hook inside your pages instead of the server-side rendering methods ([`getStaticProps`](/docs/13/pages/building-your-application/data-fetching/get-static-props) and [`getServerSideProps`](/docs/13/pages/building-your-application/data-fetching/get-server-side-props)).
...
\
Use Server-side Rendering to render pages on each request.](/docs/13/pages/building-your-application/rendering/server-side-rendering)
...
\
Use Static Site Generation (SSG) to pre-render pages at build time.](/docs/13/pages/building-your-application/rendering/static-site-generation)
...
\
Learn how to create or update static pages at runtime with Incremental Static Regeneration.](/docs/13/pages/building-your-application/rendering/incremental-static-regeneration)
