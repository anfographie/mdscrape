...
source: "https://nextjs.org/docs/13/pages/building-your-application/rendering/incremental-static-regeneration"
---
...
[Building Your Application](/docs/13/pages/building-your-application)[Rendering](/docs/13/pages/building-your-application/rendering)Incremental Static Regeneration (ISR)
...
> **Good to know**: The [`edge` runtime](/docs/13/app/api-reference/edge) is currently not compatible with ISR, although you can leverage `stale-while-revalidate` by setting the `cache-control` header manually.
