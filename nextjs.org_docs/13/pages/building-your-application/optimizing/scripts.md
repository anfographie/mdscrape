...
source: "https://nextjs.org/docs/13/pages/building-your-application/optimizing/scripts"
---
...
[Building Your Application](/docs/13/pages/building-your-application)[Optimizing](/docs/13/pages/building-your-application/optimizing)Scripts
...
Refer to the [`next/script`](/docs/13/pages/api-reference/components/script#onload) API reference to learn more about each event handler and view examples.
