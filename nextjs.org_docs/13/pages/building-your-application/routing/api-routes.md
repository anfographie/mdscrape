...
[Building Your Application](/docs/13/pages/building-your-application)[Routing](/docs/13/pages/building-your-application/routing)API Routes
...
> **Good to know**: If you are using the App Router, you can use [Server Components](/docs/13/app/building-your-application/data-fetching/fetching-caching-and-revalidating) or [Route Handlers](/docs/13/app/building-your-application/routing/route-handlers) instead of API Routes.
...
- API Routes can't be used with [static exports](/docs/13/pages/building-your-application/deploying/static-exports). However, [Route Handlers](/docs/13/app/building-your-application/routing/route-handlers) in the App Router can.
  
  > - API Routes will be affected by [`pageExtensions` configuration](/docs/13/pages/api-reference/next-config-js/pageExtensions) in `next.config.js`.
...
- `req`: An instance of [http.IncomingMessage](https://nodejs.org/api/http.html#class-httpincomingmessage), plus some [pre-built middlewares](/docs/13/pages/api-reference/functions/next-server)
- `res`: An instance of [http.ServerResponse](https://nodejs.org/api/http.html#class-httpserverresponse), plus some [helper functions](/docs/13/pages/api-reference/functions/next-server)
...
- `res.revalidate(urlPath)` - [Revalidate a page on demand](/docs/13/pages/building-your-application/data-fetching/incremental-static-regeneration#on-demand-revalidation) using `getStaticProps`. `urlPath` must be a `string`.
...
API Routes support [dynamic routes](/docs/13/pages/building-your-application/routing/dynamic-routes), and follow the same file naming rules used for `pages/`.
...
If you would like to use API Routes with the Edge Runtime, we recommend incrementally adopting the App Router and using [Route Handlers](/docs/13/app/building-your-application/routing/route-handlers) instead.
