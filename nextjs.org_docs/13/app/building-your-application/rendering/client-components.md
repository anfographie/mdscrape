...
source: "https://nextjs.org/docs/13/app/building-your-application/rendering/client-components"
---
...
[Building Your Application](/docs/13/app/building-your-application)[Rendering](/docs/13/app/building-your-application/rendering)Client Components
...
`"use client"` is used to declare a [boundary](/docs/13/app/building-your-application/rendering#network-boundary) between a Server and Client Component modules. This means that by defining a `"use client"` in a file, all other modules imported into it, including child components, are considered part of the client bundle.
...
![Use Client Directive and Network Boundary](/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fdocs%2Flight%2Fuse-client-directive.png&w=3840&q=75)![Use Client Directive and Network Boundary](/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fdocs%2Fdark%2Fuse-client-directive.png&w=3840&q=75)
...
You can keep code on the server even though it's theoretically nested inside Client Components by interleaving Client and Server Components and Server Actions. See the [Composition Patterns](/docs/13/app/building-your-application/rendering/composition-patterns) page for more information.
