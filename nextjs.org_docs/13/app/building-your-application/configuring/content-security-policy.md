...
[Building Your Application](/docs/13/app/building-your-application)[Configuring](/docs/13/app/building-your-application/configuring)Content Security Policy
...
**headers**  
\
API reference for the headers function.](/docs/13/app/api-reference/functions/headers)
