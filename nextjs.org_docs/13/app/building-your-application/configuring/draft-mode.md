---
title: "Draft Mode"
source: "https://nextjs.org/docs/13/app/building-your-application/configuring/draft-mode"
---
...
[Building Your Application](/docs/13/app/building-your-application)[Configuring](/docs/13/app/building-your-application/configuring)Draft Mode

You are currently viewing documentation for version 13 of Next.js.

# Draft Mode

Static rendering is useful when your pages fetch data from a headless CMS. However, it’s not ideal when you’re writing a draft on your headless CMS and want to view the draft immediately on your page. You’d want Next.js to render these pages at **request time** instead of build time and fetch the draft content instead of the published content. You’d want Next.js to switch to [dynamic rendering](/docs/13/app/building-your-application/rendering/server-components#dynamic-rendering) only for this specific case.
...
First, create a [Route Handler](/docs/13/app/building-your-application/routing/route-handlers). It can have any name - e.g. `app/api/draft/route.ts`
...
Then, send a request to `/api/disable-draft` to invoke the Route Handler. If calling this route using [`next/link`](/docs/13/app/api-reference/components/link), you must pass `prefetch={false}` to prevent accidentally deleting the cookie on prefetch.
