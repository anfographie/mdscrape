...
[Building Your Application](/docs/13/app/building-your-application)[Configuring](/docs/13/app/building-your-application/configuring)ESLint
...
> If you do not want ESLint to run during `next build`, refer to the documentation for [Ignoring ESLint](/docs/13/app/api-reference/next-config-js/eslint).
