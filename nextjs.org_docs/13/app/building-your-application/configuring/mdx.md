...
[Building Your Application](/docs/13/app/building-your-application)[Configuring](/docs/13/app/building-your-application/configuring)MDX
...
To share a layout amongst MDX pages, you can use the [built-in layouts support](/docs/13/app/building-your-application/routing/pages-and-layouts#layouts) with the App Router.
