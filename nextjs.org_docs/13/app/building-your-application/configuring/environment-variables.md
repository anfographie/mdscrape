...
source: "https://nextjs.org/docs/13/app/building-your-application/configuring/environment-variables"
---
...
[Building Your Application](/docs/13/app/building-your-application)[Configuring](/docs/13/app/building-your-application/configuring)Environment Variables
...
This loads `process.env.DB_HOST`, `process.env.DB_USER`, and `process.env.DB_PASS` into the Node.js environment automatically allowing you to use them in [Route Handlers](/docs/13/app/building-your-application/routing/route-handlers).
