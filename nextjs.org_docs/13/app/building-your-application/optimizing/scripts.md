...
[Building Your Application](/docs/13/app/building-your-application)[Optimizing](/docs/13/app/building-your-application/optimizing)Scripts
...
Refer to the [`next/script`](/docs/13/app/api-reference/components/script#strategy) API reference documentation to learn more about each strategy and their use cases.
...
These handlers will only work when `next/script` is imported and used inside of a [Client Component](/docs/13/app/building-your-application/rendering/client-components) where `"use client"` is defined as the first line of code:
...
Refer to the [`next/script`](/docs/13/app/api-reference/components/script#onload) API reference to learn more about each event handler and view examples.
...
**&lt;Script&gt;**  
\
Optimize third-party scripts in your Next.js application using the built-in \`next/script\` Component.](/docs/13/app/api-reference/components/script)
