...
[Building Your Application](/docs/13/app/building-your-application)[Data Fetching](/docs/13/app/building-your-application/data-fetching)Forms and Mutations
...
Server Actions integrate deeply with the Next.js [caching and revalidation](/docs/13/app/building-your-application/caching) architecture. When a form is submitted, the Server Action can update cached data and revalidate any cache keys that should change.
...
Server Actions allow you to invalidate the [Next.js Cache](/docs/13/app/building-your-application/caching) on demand. You can invalidate an entire route segment with [`revalidatePath`](/docs/13/app/api-reference/functions/revalidatePath):
...
If you would like to redirect the user to a different route after the completion of a Server Action, you can use [`redirect`](/docs/13/app/api-reference/functions/redirect) and any absolute or relative URL:
...
You can set cookies inside a Server Action using the [`cookies`](/docs/13/app/api-reference/functions/cookies) function:
...
You can read cookies inside a Server Action using the [`cookies`](/docs/13/app/api-reference/functions/cookies) function:
...
You can delete cookies inside a Server Action using the [`cookies`](/docs/13/app/api-reference/functions/cookies) function:
