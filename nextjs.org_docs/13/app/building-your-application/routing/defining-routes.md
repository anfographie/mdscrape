...
[Building Your Application](/docs/13/app/building-your-application)[Routing](/docs/13/app/building-your-application/routing)Defining Routes

You are currently viewing documentation for version 13 of Next.js.

# Defining Routes

> We recommend reading the [Routing Fundamentals](/docs/13/app/building-your-application/routing) page before continuing.
...
Each folder represents a [**route** segment](/docs/13/app/building-your-application/routing#route-segments) that maps to a **URL** segment. To create a [nested route](/docs/13/app/building-your-application/routing#nested-routes), you can nest folders inside each other.
...
A special [`page.js` file](/docs/13/app/building-your-application/routing/pages-and-layouts#pages) is used to make route segments publicly accessible.
...
[Special file conventions](/docs/13/app/building-your-application/routing#file-conventions) are used to create UI for each route segment. The most common are [pages](/docs/13/app/building-your-application/routing/pages-and-layouts#pages) to show UI unique to a route, and [layouts](/docs/13/app/building-your-application/routing/pages-and-layouts#layouts) to show UI that is shared across multiple routes.
