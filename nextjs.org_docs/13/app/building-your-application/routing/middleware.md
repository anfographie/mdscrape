...
[Building Your Application](/docs/13/app/building-your-application)[Routing](/docs/13/app/building-your-application/routing)Middleware
...
1. `rewrite` to a route ([Page](/docs/13/app/building-your-application/routing/pages-and-layouts) or [Route Handler](/docs/13/app/building-your-application/routing/route-handlers)) that produces a response
