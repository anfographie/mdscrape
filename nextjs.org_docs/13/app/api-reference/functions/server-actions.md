...
[API Reference](/docs/13/app/api-reference)[Functions](/docs/13/app/api-reference/functions)Server Actions

You are currently viewing documentation for version 13 of Next.js.

# Server Actions

Next.js integrates with React Actions to provide a built-in solution for [server mutations](/docs/13/app/building-your-application/data-fetching/forms-and-mutations).
