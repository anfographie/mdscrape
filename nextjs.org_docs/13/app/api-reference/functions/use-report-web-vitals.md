...
source: "https://nextjs.org/docs/13/app/api-reference/functions/use-report-web-vitals"
---
...
[API Reference](/docs/13/app/api-reference)[Functions](/docs/13/app/api-reference/functions)useReportWebVitals
