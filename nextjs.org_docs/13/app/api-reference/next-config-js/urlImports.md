---
title: "urlImports"
source: "https://nextjs.org/docs/13/app/api-reference/next-config-js/urlImports"
---
...
[API Reference](/docs/13/app/api-reference)[next.config.js Options](/docs/13/app/api-reference/next-config-js)urlImports
