---
title: "error.js"
source: "https://nextjs.org/docs/13/app/api-reference/file-conventions/error"
---
...
[API Reference](/docs/13/app/api-reference)[File Conventions](/docs/13/app/api-reference/file-conventions)error.js
...
> **Good to know**:
> 
> - `error.js` boundaries must be [**Client Components**](/docs/13/app/building-your-application/rendering/client-components).
