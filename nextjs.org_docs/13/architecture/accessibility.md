---
title: "Accessibility"
source: "https://nextjs.org/docs/13/architecture/accessibility"
---
...
[Introduction](/docs/13)[Architecture](/docs/13/architecture)Accessibility
...
Next.js provides an [integrated ESLint experience](/docs/13/pages/building-your-application/configuring/eslint) out of the box, including custom rules for Next.js. By default, Next.js includes `eslint-plugin-jsx-a11y` to help catch accessibility issues early, including warning on:
