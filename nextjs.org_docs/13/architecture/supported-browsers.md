...
source: "https://nextjs.org/docs/13/architecture/supported-browsers"
---
...
[Introduction](/docs/13)[Architecture](/docs/13/architecture)Supported Browsers
...
In this case, you should add a top-level import for the **specific polyfill** you need in your [Custom `<App>`](/docs/13/pages/building-your-application/routing/custom-app) or the individual component.
...
### [Server-Side Polyfills](#server-side-polyfills)
...
Next.js has built-in TypeScript support. [Learn more here](/docs/13/pages/building-your-application/configuring/typescript).

### [Customizing Babel Config (Advanced)](#customizing-babel-config-advanced)

You can customize babel configuration. [Learn more here](/docs/13/pages/building-your-application/configuring/babel).
